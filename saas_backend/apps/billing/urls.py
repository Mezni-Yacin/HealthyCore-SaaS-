...
urlpatterns = [
    ...
    path('doctor/invoices/<int:pk>/pdf/', DoctorInvoiceViewSet.as_view({'get': 'generate_pdf'}), name='doctor-invoice-pdf'), # <-- NOUVEAU
    ...
    path('secretary/invoices/<int:pk>/pdf/', SecretaryInvoiceViewSet.as_view({'get': 'generate_pdf'}), name='secretary-invoice-pdf'), # <-- NOUVEAU
    ...
    path('patient/invoices/<int:pk>/pdf/', PatientInvoiceViewSet.as_view({'get': 'generate_pdf'}), name='patient-invoice-pdf'), # <-- NOUVEAU
    ...
    path('superadmin/invoices/<int:pk>/pdf/', SuperAdminInvoiceViewSet.as_view({'get': 'generate_pdf'}), name='superadmin-invoice-pdf'), # <-- NOUVEAU
