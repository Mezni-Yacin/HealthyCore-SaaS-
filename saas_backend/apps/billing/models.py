...
class Invoice(models.Model):
    ...
    tax_amount = models.DecimalField(max_digits=10, decimal_places=3, default=0.000)
    ...
    cnam_contribution = models.DecimalField(max_digits=10, decimal_places=3, default=0.000)
    insurance_contribution = models.DecimalField(max_digits=10, decimal_places=3, default=0.000)
    patient_contribution = models.DecimalField(max_digits=10, decimal_places=3, default=0.000)
