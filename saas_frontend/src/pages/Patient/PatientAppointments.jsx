...
/* ------------------------------------------------------------------ */
/*  Status / consultation-type mapping tables                         */
/* ------------------------------------------------------------------ */
...
const PatientAppointments = () => {
  ...
  const renderConsultationBadge = (consultationType, consultationTypeDisplay) => {
    const label =
      CONSULTATION_LABEL[consultationType] || consultationTypeDisplay || consultationType;
    return (
    ...
    <div className="container py-4">
        ...
        <div className="card-body">
          <div className="row g-3 align-items-end">
            ...
            <div className="col-md-3 col-sm-6">
              <label htmlFor="filter-status" className="form-label fw-semibold small text-muted">
                Statut
              </label>
              <select
                id="filter-status"
            ...
            {/* Date from */}
            <div className="col-md-3 col-sm-6">
              <label htmlFor="filter-date-from" className="form-label fw-semibold small text-muted">
                Date debut
              </label>
              <input
                id="filter-date-from"
            ...
            {/* Date to */}
            <div className="col-md-3 col-sm-6">
              <label htmlFor="filter-date-to" className="form-label fw-semibold small text-muted">
                Date fin
              </label>
              <input
                id="filter-date-to"
            ...
            <div className="col-md-3 col-sm-6">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 16 16"
                >
                  <path d="M7.352 10.354a.5.5 0 0 1-.708 0l-2-2a.5.5 0 0 1 0-.708l2-2a.5.5 0 1 1 .708.708L6.06 7h5.44A1.5 1.5 0 0 1 13 8.5v1a.5.5 0 0 1-1 0v-1a.5.5 0 0 0-.5-.5H6.06l1.293 1.293a.5.5 0 0 1 0 .708z" />
                  <path d="M1 8a7 7 0 1 0 2.54-5.39l-.86-.86A.5.5 0 0 0 1.93 2.4l1.732 1.732a.5.5 0 0 0 .708 0l1.732-1.732a.5.5 0 1 0-.708-.708l-.86.86A8 8 0 1 1 0 8z" />
                </svg>
                Reinitialiser
              </button>
            </div>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <p className="mb-0 text-muted small">
          {totalCount} rendez-vous{totalCount > 1 ? 's' : ''} trouve{totalCount > 1 ? 's' : ''}
        </p>
      </div>
      ...
      {!loading && !error && appointments.length === 0 && (
        <div className="text-center py-5">
          ...
          <p className="text-muted small">
            {filterStatus || filterDateFrom || filterDateTo
              ? 'Aucun rendez-vous ne correspond a vos filtres de recherche.'
      ...
      {!loading && !error && appointments.length > 0 && (
        <div className="row g-3">
          {appointments.map((appt) => {
            const past = isPast(appt.date_time);
            return (
              <div className="col-lg-4 col-md-6" key={appt.id}>
                <div
                  className={`card border h-100 shadow-sm appointment-card ${
                    past ? 'opacity-75' : ''
                  }`}
                  role="button"
                  tabIndex={0}
                ...
                >
                  ...
                  <div className="card-body d-flex flex-column">
                    ...
                    <p className="text-muted small mb-2">
                      ...
                      {appt.duration && (
                        <span className="ms-1">({appt.duration} min)</span>
                      )}
                    </p>
                    ...
                    <div className="d-flex flex-wrap gap-1 mb-2">
                      {renderConsultationBadge(
                        ...
                        appt.consultation_type_display
                      )}
                    ...
                    {appt.symptoms_summary && (
                      <p className="text-muted small mb-0 mt-auto" style={{ lineHeight: 1.4 }}>
                        ...
                        {appt.symptoms_summary.length > 80
                          ? `${appt.symptoms_summary.substring(0, 80)}...`
                          : appt.symptoms_summary}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="card-footer bg-white border-top py-2 px-3">
                    <small className="text-primary fw-semibold">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M6.646 3.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L12.293 10 6.646 4.354a.5.5 0 0 1 0-.708z"
                        />
                      </svg>
                    </small>
                  </div>
