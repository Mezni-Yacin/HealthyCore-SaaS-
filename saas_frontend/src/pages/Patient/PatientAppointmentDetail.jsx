...
/* ------------------------------------------------------------------ */
/*  Mapping tables (Couleurs et options de modal uniquement)           */
/* ------------------------------------------------------------------ */
...
const CANCELLATION_REASON_OPTIONS = [
  ...
  { value: 'doctor', label: 'Médecin - indisponible' },
...
const PatientAppointmentDetail = () => {
  ...
  /* ---- handlers ---- */
  const handleBack = () => {
    navigate(-1); // utilise l'historique plutôt qu'un hardcode
  };
  ...
  const handleCancelAppointment = async () => {
    if (!cancellationReason) {
      setCancelError('Veuillez sélectionner une raison d\'annulation.');
      return;
    }
  ...
  if (loading) {
    return (
      <div className="container py-5 text-center">
        ...
        <p className="text-muted small mt-2">Chargement du rendez-vous…</p>
      </div>
    );
  }
    ...
    return (
      <div className="container py-5">
        <div className="text-center py-5">
          <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-question-circle text-muted mb-3" viewBox="0 0 16 16">
    ...
    <div className="container py-4">
      ...
      <div className="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <div className="d-flex align-items-center">
          ...
          <div>
            <h4 className="mb-0 fw-bold">Rendez-vous #{appointment.id}</h4>
          </div>
        </div>
      ...
      <div className="row g-4">
        ...
        <div className="col-lg-5">
          ...
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header bg-primary bg-opacity-10 border-0 py-2 px-3">
              <h6 className="mb-0 fw-semibold text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-person-badge me-1" viewBox="0 0 16 16">
              ...
              {appointment.doctor_info ? (
                <>
                  ...
                  {appointment.doctor_info.specialty && (
                    <p className="mb-1">
                      <span className="text-muted small me-1">Spécialité :</span>
                  ...
                  {appointment.doctor_info.email && (
                    <p className="mb-0">
                      ...
                      <a href={`mailto:${appointment.doctor_info.email}`} className="text-decoration-none">
                        {appointment.doctor_info.email}
                      </a>
                    </p>
                  )}
                ...
                <p className="mb-0 fw-bold">Dr. {appointment.doctor_name}</p>
              )}
            </div>
          </div>
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-header bg-primary bg-opacity-10 border-0 py-2 px-3">
              <h6 className="mb-0 fw-semibold text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-building me-1" viewBox="0 0 16 16">
            ...
            <div className="card-body">
              {appointment.cabinet_info ? (
                <>
                  ...
                  {appointment.cabinet_info.phone && (
                    <p className="mb-0 small">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-telephone me-1" viewBox="0 0 16 16">
                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328z" />
                      </svg>
                      <a href={`tel:${appointment.cabinet_info.phone}`} className="text-decoration-none">
                        {appointment.cabinet_info.phone}
                      </a>
                    </p>
                  )}
                ...
                <p className="mb-0">{appointment.cabinet_name || 'Non précisé'}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-7">
          ...
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header bg-primary bg-opacity-10 border-0 py-2 px-3">
              <h6 className="mb-0 fw-semibold text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-info-circle me-1" viewBox="0 0 16 16">
                  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
            ...
            <div className="card-body">
              <div className="row g-3">
                ...
                <div className="col-sm-6">
                  <p className="mb-0 small text-muted fw-semibold">Durée</p>
                  <p className="mb-0 fw-medium">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hourglass me-1" viewBox="0 0 16 16">
                ...
                <div className="col-sm-6">
                  ...
                  <p className="mb-0">
                    <span className="badge bg-light text-dark border">
                      {appointment.consultation_type_display || appointment.consultation_type}
                    </span>
                  </p>
                </div>
                ...
                <div className="col-sm-6">
                  ...
                  <p className="mb-0">
                    {appointment.is_teleconsultation ? (
                      <span className="badge bg-white border border-primary text-primary">Téléconsultation</span>
                    ) : (
                      <span className="badge bg-white border border-success text-success">Consultation en cabinet</span>
                    )}
                  </p>
                </div>
              </div>
            ...
            <div className="card border-0 shadow-sm mb-3">
              <div className="card-header bg-warning bg-opacity-10 border-0 py-2 px-3">
                <h6 className="mb-0 fw-semibold text-warning">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-clipboard2-pulse me-1" viewBox="0 0 16 16">
            ...
            <div className="card border-0 shadow-sm mb-3">
              <div className="card-header bg-info bg-opacity-10 border-0 py-2 px-3">
                <h6 className="mb-0 fw-semibold text-info">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-journal-text me-1" viewBox="0 0 16 16">
            ...
            <div className="card border-0 shadow-sm mb-3 border-start border-danger border-4">
              <div className="card-header bg-danger bg-opacity-10 border-0 py-2 px-3">
                <h6 className="mb-0 fw-semibold text-danger">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-x-octagon me-1" viewBox="0 0 16 16">
                ...
                {appointment.cancellation_reason && (
                  <p className="mb-1">
                    ...
                    <span className="fw-medium">
                      {CANCELLATION_REASON_LABEL[appointment.cancellation_reason] || appointment.cancellation_reason_display || appointment.cancellation_reason}
                    </span>
                  </p>
                )}
                {appointment.cancellation_notes && (
                  <p className="mb-0">
                    <span className="text-muted small me-1">Détails :</span>
          ...
          <div className="card border-0 shadow-sm mb-3">
            <div className="card-header bg-success bg-opacity-10 border-0 py-2 px-3">
              <h6 className="mb-0 fw-semibold text-success">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-bell me-1" viewBox="0 0 16 16">
                ...
                <span className="small">
                  {appointment.reminder_sent_24h ? (
                    <span className="text-success">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-check-circle-fill me-1" viewBox="0 0 16 16">
                    ...
                    <span className="text-muted">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-dash-circle me-1" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                        <path d="M4 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 4 8z" />
                      </svg>
                      Rappel 24h non envoyé
                    </span>
                  )}
                </span>
                <span className="small">
          ...
          {/* Cancel button or Info alert */}
          {canCancel ? (
            <div className="d-flex justify-content-end mt-3">
              <button type="button" className="btn btn-danger" onClick={handleOpenCancelModal}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-x-circle me-1" viewBox="0 0 16 16">
                  <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z" />
                </svg>
            ...
            !['cancelled', 'completed', 'no_show'].includes(appointment.status) && (
              <div className="alert alert-warning small py-2 mt-3 mb-0">
                ...
                {isAppointmentPast(appointment.date_time)
                  ? "La date de ce rendez-vous est passée. L'annulation n'est plus possible."
                  : "Ce rendez-vous est en cours, il ne peut plus être annulé."}
              </div>
            )
          )}
        </div>
      ...
      <div className="card border-0 shadow-sm mt-4">
        <div className="card-body py-2">
          <div className="row small text-muted">
            <div className="col-sm-6">
              <span className="fw-semibold">Créé le :</span>{' '}
              {appointment.created_by_name ? `${appointment.created_by_name} - ` : ''}
              {formatDate(appointment.created_at)}
            </div>
            <div className="col-sm-6">
              <span className="fw-semibold">Modifié le :</span>{' '}
              {appointment.last_modified_by_name ? `${appointment.last_modified_by_name} - ` : ''}
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title fw-bold">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-exclamation-triangle text-warning me-2" viewBox="0 0 16 16">
                ...
                <button type="button" className="btn-close" onClick={handleCloseCancelModal} disabled={cancelSubmitting} aria-label="Fermer" />
              </div>
              ...
              <div className="modal-body">
                ...
                {cancelError && (
                  <div className="alert alert-danger small py-2" role="alert">{cancelError}</div>
                )}

                <div className="mb-3">
                  <label htmlFor="cancellation-reason" className="form-label fw-semibold">
                ...
                <div className="mb-0">
                  <label htmlFor="cancellation-notes" className="form-label fw-semibold">
              ...
              <div className="modal-footer">
                ...
                <button type="button" className="btn btn-danger" onClick={handleCancelAppointment} disabled={cancelSubmitting || !cancellationReason}>
                  {cancelSubmitting ? (
                    <>
