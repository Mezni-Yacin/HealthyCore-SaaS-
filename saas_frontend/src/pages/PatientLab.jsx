...
const STATUS_MAP = {
    requested: 'secondary', sample_collected: 'info', in_progress: 'warning text-dark',
    completed: 'success', cancelled: 'danger'
};

const STATUS_LABELS = {
    requested: 'En attente', sample_collected: 'Prélevé', in_progress: 'En cours',
...
const PatientLab = () => {
    ...
    const handleAskAI = () => {
        ...
        api.post('/ai/explain-results/', { request_id: resultData.request_info.id })
            ...
            .catch(err => setAiError(err.response?.data?.error || "Erreur lors de la communication avec l'IA."))
    ...
    return (
        <div className="container-fluid py-4">
            <div className="mb-4">
                ...
                <p className="text-muted mb-0">Consultez votre historique, vos résultats et le statut de vos paiements</p>
            </div>
                                ...
                                <tbody>
                                    {filteredRequests.map(req => (
                                        <tr key={req.id}>
                                            ...
                                            {/* ✅ AFFICHAGE STATUT PAIEMENT PATIENT */}
                                            <td>
