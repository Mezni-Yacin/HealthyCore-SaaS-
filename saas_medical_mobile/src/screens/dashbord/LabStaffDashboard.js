// src/screens/dashbord/LabStaffDashboard.js
...
export default function LabStaffDashboard() {
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.title}>Personnel de Laboratoire 🧪</Text>

      <View style={styles.grid}>
        <View style={styles.card}>
          <Text style={styles.cardTitle}>Analyses en cours</Text>
          <Text style={styles.number}>22</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Résultats à valider</Text>
          <Text style={styles.number}>7</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Urgents aujourd'hui</Text>
          <Text style={styles.number}>3</Text>
        </View>
      </View>

      <Text style={styles.footer}>
        Liste des analyses, résultats et communication avec les médecins
      </Text>
    </ScrollView>
  );
}
